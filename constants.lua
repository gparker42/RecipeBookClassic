...
constants.gui_strings = {
  ...
  catalyst_abbrev = { "gui.rb-catalyst-abbrev" },
  catalyst_amount = { "gui.rb-catalyst-amount" },
  ...
  degrees_C = { "si-unit-degree-celsius" },
  ...
  format_seconds_short = { "time-symbol-seconds-short" },
  format_minutes_short = { "time-symbol-minutes-short" },
  format_hours_short = { "time-symbol-hours-short" },
  ...
  input_fluid = { "gui.rb-input-fluid" },
  ...
  output_fluid = { "gui.rb-output-fluid" },
  ...
  pollution_multiplier = { "gui.rb-pollution-multiplier" },
  ...
  spoil_result = { "gui.rb-spoil-result" },
  spoil_result_of = { "gui.rb-spoil-result-of" },
  spoil_time = { "gui.rb-spoil-time" },
  ...
  entity = {
    {
      ...
      rows = {
        ...
        { type = "goto",  source = "input_fluid", options = { always_show = true, hide_glyph = true } },
        { type = "goto",  source = "output_fluid", options = { always_show = true, hide_glyph = true } },
      },
    },
  ...
  item = {
    {
      ...
      rows = {
        ...
        { type = "goto", source = "spoil_result" },
        { type = "plain", source = "spoil_time", formatter = "hour_min_sec_from_ticks" },
      },
    },
    ...
    { type = "list_box", source = "spoil_result_of" },
    { type = "list_box", source = "accepted_equipment", default_state = "collapsed" },
    { type = "list_box", source = "equipment_categories", default_state = "hidden" },
    { type = "list_box", source = "unlocked_by" },
  },
  ...
  resource = {
    {
      ...
      rows = {
        ...
        { type = "plain", source = "mining_time", formatter = "seconds" },
      },
    },
...
constants.tooltips = {
  ...
  recipe = {
    { type = "plain", source = "group", formatter = "object", options = { hide_glyph = true } },
    { type = "plain", source = "energy", label = "crafting_time", formatter = "seconds" },
